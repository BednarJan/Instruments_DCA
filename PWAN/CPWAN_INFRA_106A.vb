'Class CPWAN_INFRA_106A
'06.01.2019, A. Zahler
'Compatible Instruments:
'- Infratek 106A
Imports Ivi.Visa

Public Class CPWAN_INFRA_106A
    Implements IDevice
    Implements IPWAN
...
#Region "Basic Device Functions (IDevice)"
    ...
    Public Sub Initialize() Implements IDevice.Initialize
        ...
        _Visa.SendString("ACQUIRE:SYNCHRO VOLTAGE")
        '_Visa.SendString("FORMAT:START 1")
        '_Visa.SendString("FORMAT:END 13")
    End Sub
#End Region
...
#Region "Public Special Functions 106A"
