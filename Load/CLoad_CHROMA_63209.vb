'Class CLoad_CHROMA_63209
'17.02.2019, A. Zahler
'Compatible Instruments:
'- Chroma 63209 (single channel)
Imports Ivi.Visa

Public Class CLoad_CHROMA_63209
    Implements IDevice
    Implements ILoad
...
#Region "Shorthand Properties"
    ...
    Public ReadOnly Property CurrentMax As Single = 1000 Implements ILoad.CurrentMax
    Public ReadOnly Property PowerMax As Single = 15600 Implements ILoad.PowerMax
#End Region
...
#Region "Basic Device Functions (IDevice)"
    ...
    Public Sub Initialize() Implements IDevice.Initialize
        ...
        _Visa.SendString("VOLT:STAT:L1 80")
        _Visa.SendString("VOLT:STAT:L2 80")
        ...
        _Visa.SendString("CONF:VOLT:ON 500mV")
...
#Region "Interface ILoad Methodes"
    ...
    Public Sub SetCCPulse(ByVal CCInitial As Single, ByVal CCPulse As Single, Duration_s As Single, Optional SlewRate As Single = 1) Implements ILoad.SetCCPulse
        ...
        _Visa.SendString("CURR:DYN:T1 1s")
        _Visa.SendString("CURR:DYN:T2 " & Duration_s & "s")
        _Visa.SendString("CURR:DYN:RISE " & SlewRate)
        _Visa.SendString("CURR:DYN:FALL " & SlewRate)
        _Visa.SendString("LOAD ON")
    End Sub
...
#Region "Public Special Functions CHROMA 63209"
