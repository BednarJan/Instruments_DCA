'Class CLoad_CHROMA_63212E_150_1200
'17.03.2019, A. Zahler
'Compatible Instruments:
'- Chroma 63212E-150-1200 (single channel)
Imports Ivi.Visa

Public Class CLoad_CHROMA_63212E_150_1200
    Implements IDevice
    Implements ILoad
...
#Region "Shorthand Properties"
    ...
    Public ReadOnly Property CurrentMax As Single = 1200 Implements ILoad.CurrentMax
    Public ReadOnly Property PowerMax As Single = 12000 Implements ILoad.PowerMax
#End Region
...
#Region "Basic Device Functions (IDevice)"
    ...
    Public Sub Initialize() Implements IDevice.Initialize
        ...
        _Visa.SendString("VOLT:STAT:L1 150")
        _Visa.SendString("VOLT:STAT:L2 150")
        ...
        _Visa.SendString("CONG:VOLT:ON 5")
...
#Region "Public Special Functions CHROMA 63212E-150-1200"
