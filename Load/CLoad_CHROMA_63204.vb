...
#Region "Shorthand Properties"
    ...
    Public ReadOnly Property VoltageMax As Single = 500 Implements ILoad.VoltageMax
    Public ReadOnly Property CurrentMax As Single = 100 Implements ILoad.CurrentMax
    Public ReadOnly Property PowerMax As Single = 5200 Implements ILoad.PowerMax
#End Region
...
#Region "Basic Device Functions (IDevice)"
    ...
    Public Sub Initialize() Implements IDevice.Initialize
        ...
        _Visa.SendString("RES:L1 20000")
        _Visa.SendString("RES:L2 20000")
        _Visa.SendString("RES:RISE 1")
        _Visa.SendString("RES:FALL 1")
        _Visa.SendString("MODE CVH")
        _Visa.SendString("VOLT:MODE SLOW")
        _Visa.SendString("VOLT:STAT:L1 500")
        _Visa.SendString("VOLT:STAT:L2 500")
...
#Region "Public Special Functions CHROMA 63204"
