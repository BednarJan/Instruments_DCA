'Class CSourceDC_TOELLNER_8872_80
'08.04.2019, A. Zahler
'Compatible Instruments:
'- Toellner 8872-80 (single channel)
Imports Ivi.Visa

Public Class CSourceDC_TOELLNER_8872_80
    Implements IDevice
...
#Region "Shorthand Properties"
    ...
    Public ReadOnly Property CurrentMax As Single = 50 Implements ISource_DC.CurrentMax
    Public ReadOnly Property PowerMax As Single = 1500 Implements ISource_DC.PowerMax
#End Region
...
#Region "Basic Device Functions (IDevice)"
    ...
    Public Sub Initialize() Implements IDevice.Initialize
        ...
        _Visa.SendString("SENS:VOLT:DET INT")
