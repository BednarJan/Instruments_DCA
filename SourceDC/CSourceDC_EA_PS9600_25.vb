...
#Region "Shorthand Properties"
    ...
    Public ReadOnly Property VoltageMax As Single = 600 Implements ISource_DC.VoltageMax
    Public ReadOnly Property CurrentMax As Single = 25 Implements ISource_DC.CurrentMax
    Public ReadOnly Property PowerMax As Single = 6000 Implements ISource_DC.PowerMax
#End Region
