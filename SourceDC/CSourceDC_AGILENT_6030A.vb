...
#Region "Shorthand Properties"
    ...
    Public ReadOnly Property VoltageMax As Single = 200 Implements ISource_DC.VoltageMax
    Public ReadOnly Property CurrentMax As Single = 17 Implements ISource_DC.CurrentMax
    Public ReadOnly Property PowerMax As Single = 1200 Implements ISource_DC.PowerMax
#End Region
